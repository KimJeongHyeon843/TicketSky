...
<hr><br><br><br>
(${notice.NOTICENO})
<button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="fn_noticeModify(${notice.NOTICENO});" style="margin:0 0 0 78%">수정</button>
...
<tr>
 ...
 <tr>
	 <td>내용</td>
	 <td height="300px"><input type="text" name="content" id="content" placeholder="내용을 입력하세요." style="width:600px; height:300px" readonly value="${notice.CONTENT}">
	 </td>
 </tr>
