...
<tr>
<td>글제목</td>
 <td><input type="text" name="title" id="title" placeholder="글제목" style="width:600px" value="${notice.title}"/>
 </td>
 </tr>
 <tr>
 <td>내용</td>
 <td height="300px"><input type="text" name="content" id="content" placeholder="내용을 입력하세요." style="width:600px; height:300px" value="${notice.content}"/>
 </td>
 </tr>
 <tr id="openDate">
	 <td>예매오픈일</td>
	 <td><input type="date" name="openDate" id="openDate" placeholder="등록일을 입력하세요." value="${notice.openDate}"/>
	 </td>
 </tr> 
...
<div class='row justify-content-center'>
	...
	&nbsp;<button class="btn btn-outline-success my-2 my-sm-0" onclick="notice();" type="submit">취소</button>
</div>
<br>
</form>
 </div>
 <script>
 	...
 	function notice()
 	{
 		$("#noticeFrm").attr("action","${path}/help/noticeView.do");
 		$("#noticeFrm").submit();
 	}
 </script>
