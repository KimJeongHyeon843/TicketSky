...
/*     h2{
    ...
    <div class="row">
            ...
            <p class="title">Do you need help booking a performance?</p>
            ...
            <div class="col-6 col-lg-4">
              <h2 class="headtitle">공연 안내</h2>
              <p class="title" style="margin:0 0 0 23%">새로운 공연 소식들을 빠르게 접해보세요.</p>
              <a href="${path}/help/ticketRefund.do"><button class="btn btn-default"><img src="${path }/resources/img/help-img/plane-departure-solid.svg" class="imgsize" style="margin:0 0 0 20%"/></a></button>              
            </div><!--/span-->
          </div><!--/row-->
<br>